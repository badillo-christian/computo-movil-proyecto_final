...
fun Fragment.navigateProfileToTransactions(){
    findNavController().navigate(R.id.action_profile_to_transactions)
}

fun Fragment.navigateProfileToTransfers(){
    findNavController().navigate(R.id.action_profile_to_transfers)
}

fun Fragment.navigateProfileToPayments() {
    findNavController().navigate(R.id.action_profile_to_payments)
}
fun Fragment.navigateProfileToShopping() {
    findNavController().navigate(R.id.action_profile_to_shopping)
}
fun Fragment.navigateProfileToCredits() {
    findNavController().navigate(R.id.action_profile_to_credits)
}
